...
| `PULLBOX_STORY_ARC_MANUAL_CREATE_ENABLED` | `false` | Enables manual creation of empty Story Arcs in the UI and API. Metadata-provider and import creation remain available when disabled. |
